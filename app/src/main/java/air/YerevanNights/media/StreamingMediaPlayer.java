package air.YerevanNights.media;
...
public class StreamingMediaPlayer {
	...
	private int counter = 0;
 	...
 	public StreamingMediaPlayer(Context  context,TextView textStreamed, ImageView	playButton) 
 	{
...
//		Runnable updater = new Runnable() {
//	        public void run() {
//	        //s	textStreamed.setText((totalKbRead + " Kb read"));
