...
public class DedicateActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ProgressDialog pdialog = new ProgressDialog(DedicateActivity.this);
        ...
        webView.loadUrl("http://www.yerevannights.com/music.asp");
